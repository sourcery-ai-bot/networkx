...
red_nodes = ["A", "B", "C"]
node_sizes = [250 for _ in white_nodes + red_nodes]
node_colors = ["white" for _ in white_nodes] + ["red" for _ in red_nodes]
...
c_nodes = sorted(compression_nodes)
